...
const router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    ...
    routes: [{ path: '/home', component: Home,
        children: [{ path: 'foo', component: Foo, alias: '/foo' }, { path: 'bar', component: Bar, alias: 'bar-alias' }, { path: 'baz', component: Baz, alias: ['/baz', 'baz-alias'] }, { path: 'default', component: Default, alias: '' }, { path: 'nested', component: Nested, alias: 'nested-alias',
